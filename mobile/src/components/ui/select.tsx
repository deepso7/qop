import * as SelectPrimitiveModule from "@rn-primitives/select";
import {
  Check,
  ChevronDown,
  ChevronDownIcon,
...
const SelectPrimitive = { ...SelectPrimitiveModule };

type Option = SelectPrimitiveModule.Option;
...
const SelectTrigger = ({
  ...
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "border-input dark:bg-input/30 dark:active:bg-input/50 bg-background flex h-11 flex-row items-center justify-between gap-2 rounded-md border px-3 py-2",
      Platform.select({
...
/** Web-only scroll control; returns null on native platforms. */
