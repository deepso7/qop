import * as DropdownMenuPrimitiveModule from "@rn-primitives/dropdown-menu";
import {
  Check,
  ChevronDown,
  ChevronRight,
...
const DropdownMenuPrimitive = { ...DropdownMenuPrimitiveModule };
  ...
  <DropdownMenuPrimitive.Portal hostName={portalHost}>
    <FullWindowOverlay>
      <DropdownMenuPrimitive.Overlay
        style={
          // SAFETY: flattening this array retains the absolute-fill view-style shape.
          StyleSheet.flatten([
