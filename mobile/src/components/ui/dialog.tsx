import * as DialogPrimitiveModule from "@rn-primitives/dialog";
...
const DialogPrimitive = { ...DialogPrimitiveModule };
  ...
  return (
    <FullWindowOverlay>
      <DialogPrimitive.Overlay
        ...
        {...props}
        onPress={Platform.select({ native: onPress, web: onOverlayPress })}
