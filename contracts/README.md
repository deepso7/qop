...
Foundry project for the immutable QOP identity registry and its protocol tests.

The registry is the authority for account ownership, owner versions, permanent handles, account-action nonces, and revoked certificate digests. Registration remains launch-gated by a second registration-signer signature; after registration, anyone may relay a valid signed action.
...
- Registration requires owner and registration-signer signatures over the same intent.
